...
public class Field {
    ...
    public void loadAllWeatherDataFromCsvFile() throws IOException {
     ...
     // String path = "E:\\code\\cassavaBE\\src\\main\\java\\com\\example\\demo\\data\\data_fixed_with_rain.csv";
        ...
        String path = "E:\\code\\cassavaBE\\src\\main\\java\\com\\example\\demo\\data\\data_with_thang7_troimay.csv";
           //String path = "E:\\code\\cassavaBE\\src\\main\\java\\com\\example\\demo\\data\\data_with_10days_thang7_error_raditation.csv";
    ...
    public void simulate() {
        ...
        for (int i = 0; i < ptime.size(); ++i) {
            ...
            while (t < ptime.get(i) - 0.5 * dt) {
                ...
                double irrigationDurationDays = this.customized_parameters.irrigationDuration / 24.0;
